見本に差し込む部品（AIホームページ製作所 freehp.jp）
====================================================

見込み客の要望に合わせて、見本（mihon/<slug>/）へそのまま差し込める部品のまとまり。
全部品を動かして並べたカタログ: index.html（公開後は https://freehp.jp/mihon/parts/）
...
決まりごと
  ...
  - snippet.html は手で直さない。カタログを直してから python3 tools/mihon_parts_snippets.py を流す
